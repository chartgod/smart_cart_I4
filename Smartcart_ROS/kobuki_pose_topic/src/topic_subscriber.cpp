...
{
	ROS_INFO("recieve msg = %d", msg->header.stamp.sec);
	ROS_INFO("recieve msg = %d", msg->header.stamp.nsec);
	ROS_INFO("recieve msg = %d", msg->pose.pose.position.x);
	ROS_INFO("recieve msg = %d", msg->pose.pose.position.y);
	ROS_INFO("recieve msg = %d", msg->pose.pose.orientation.z);
}
...
int main(int argc, char **argv)
{
	...
	ros::Subscriber geometry_msgs_sub = nh.subscribe("/initialpose", 100, msgCallback);

...
int main(int argc, char **argv)
{
	...
	while(ros::ok())
	{
		...
		msg.pose.pose.position.x= 3.061060;
		msg.pose.pose.position.y= 3.007341;
		msg.pose.pose.position.z= 3.001009;
		msg.pose.pose.orientation.x= -0.000269;
		msg.pose.pose.orientation.y= -0.000588;
		msg.pose.pose.orientation.z= 0.17919106;

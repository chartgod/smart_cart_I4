...
def process_sphinx_result(sphinx_output, robot_recognized):
    ...
    if robot_recognized:
        ...
        if sphinx_output == "b" or sphinx_output == "b point":
            # gTTS로 음성 출력
            ...
            if user_response.lower() == "yes" or user_response.lower() == "a c":
                ...
                print("사용자의 응답에 따라 이동하지 않습니다.")
                robot_recognized = True
        if sphinx_output == "c" or sphinx_output == "c point":
            # gTTS로 음성 출력
        ...
        if sphinx_output == "home" :
            ...
            tts.save('Home.mp3')
            mp3_process = subprocess.Popen(['mpg321', 'Home.mp3'])
            mp3_process.communicate()
            ...
            if user_response.lower() == "yes":
                ...
                user_response_event.clear()
                 ...
                 # Clear user response event before calling communicate() method
